...
public class ServicioApuestasServiceLocator extends org.apache.axis.client.Service implements servicios.ServicioApuestasService {
    ...
    private java.lang.String ServicioApuestasPort_address = "http://localhost:8080/webServicesServidorApuestas/services/ServicioApuestasPort";
    ...
    public servicios.ServidorServicioApuestas getServicioApuestasPort() throws javax.xml.rpc.ServiceException {
    ...
    public servicios.ServidorServicioApuestas getServicioApuestasPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (servicios.ServidorServicioApuestas.class.isAssignableFrom(serviceEndpointInterface)) {
